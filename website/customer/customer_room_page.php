...
<body>
    <nav>
        ...
        <div class="top_nav">
            ...
            <a href="./customer_room_page.php" class="active">ROOMS</a>
            <a href="./customer_bookings_page.php">YOUR BOOKINGS</a>
        </div>
    </nav>
    <?php
    ...
    $customer_view->check_room_availability();
