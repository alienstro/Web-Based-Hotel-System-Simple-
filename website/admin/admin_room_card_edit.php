...
if (isset($_GET['room_card_id'])) {
    $room_card_id = $_GET['room_card_id'];
        ...
        <div class="row">
            <div class="edit_container col-md-12 mt-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../admin/includes/admin_room_card_edit.inc.php" method="POST"  enctype="multipart/form-data">

                            <input type="hidden" name="room_card_id" value="<?= $result['room_card_id']; ?>" />
                            <div class="mb-3">
                                <label>Type</label>
                            ...
                            <button type="submit" name="update_room_card_btn" class="btn btn-primary">Update Room</button>
                        </form>
                    </div>
                </div>
            </div>
